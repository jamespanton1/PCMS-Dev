...
<html class="no-js" lang="">
    <head>
        ...
        <title>antonMcleod Americas News</title>
        <meta name="description" content="PantonMcleod Americas">
			...
			<div class="main-hero">
				...
				<div class="hero-picture-main bg-asset-news">
					...
					<div class="hero-title-main">
						<h5> IPantonMcleod Americas News </h5>
			...
			<div  class="content-contain">
				<div class="section group">
					...
					<!-- <div class="content-center">	
						...
						<div id="news-section" class="content-contain content-text-left">
							<div class="section group">
								<div class="col span_4_of_4">
									<div class="content-text-contain-head-article">
										 <h4> <?php echo htmlspecialchars( $results['article']->title ) ?> </h4> 
										</div>
									<div class="content-text-contain-article">	
